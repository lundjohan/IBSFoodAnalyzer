...
public final class SqLiteDao implements com.johanlund.dao.Dao {
    ...
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.TagTypeEntity> getTagTypesEntities() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.TagEntity> getTagsEntities() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.MealEntity> getMealsEntities() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.OtherEntity> getOthersEntities() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.ExerciseEntity> getExercisesEntities() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.BmEntity> getBmsEntities() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public java.util.List<com.johanlund.database.entities.RatingEntity> getRatingsEntities() {
        return null;
    }
