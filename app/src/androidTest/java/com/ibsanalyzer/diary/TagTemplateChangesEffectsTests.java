...
public class TagTemplateChangesEffectsTests {
        ...
        @Test
        public void deletedTagTemplateBackBtnTest() {
            ...
            onView(allOf(withId(R.id.stattagname), withText("Butter"))).check(matches(isDisplayed()));

            //go back into the event
            onData(anything())
                    .inAdapterView(withId(R.id.events_layout))
                    .atPosition(0)
                    .perform(click());
