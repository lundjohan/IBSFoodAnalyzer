...
public class PortionPointMakerTests {
    ...
    public void testGetPortionPointWithOnePortion() {
        ...
        TagsWrapperBase ptRatings = new TagsWrapper(Arrays.asList(ptWithinRange), Arrays.asList
                (rStart),
    ...
    public void testChunkEndIsEarly() {
        ...
        TagsWrapperBase ptRatings = new TagsWrapper(Arrays.asList(pt1), Arrays.asList(rStart),
                newYear.plusHours(6));
    ...
    public void testCutOffTimePeriodFromBothSides() {
        ...
        TagsWrapperBase ptRatings = new TagsWrapper(Arrays.asList(pt1), Arrays.asList(rStart,
                rSecond), newYear.plusHours(5));
        PortionPoint pp = getPPForRange(range, Arrays.asList(ptRatings),
                startHoursAfterMeal, stopHoursAfterMeal);


        //6 hours should be investigated: first 2 hours: no rating (don't count), between 2nd and
        // 3rd hour: 3.0,
    ...
    public void testHigherUpWithJoinThirdP() {
        ...
        TagsWrapperBase ptRatings = new TagsWrapper(Arrays.asList(p1, p2, p3), Arrays.asList
                (rStart, r2), newYear.plusHours(20));
        List<PortionPoint> pps = toReplaceCalcPoints(Arrays.asList(ptRatings), Arrays.asList
                (range), startHoursAfterMeal, stopHoursAfterMeal, 20);
    ...
    //the only thing that happens is that p1's tp is shortened by a portion larger than allowed
    // range
    @Test
    public void EXCEPTInHighHierarchyTest() {
        ...
        TagsWrapperBase ptr = new TagsWrapper(Arrays.asList(p1, p2), Arrays.asList(r1, r2),
                newYear.plusHours(20));
    ...
    public void EXCEPT_And_LateRating_InHighHierarchyTest() {
        ...
        TagsWrapperBase ptr = new TagsWrapper(Arrays.asList(p1, p2), Arrays.asList(rLate),
                newYear.plusHours(20));
