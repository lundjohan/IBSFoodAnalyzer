...
public class TimePointMakerTests {
    ...
    public void shouldReturnMiddlePartOnly(){
        ...
        List<TimePoint> tps =  TimePointMaker.doTimePoint(Arrays.asList(r1, r2, r3), newYear.plusHours(20), 1, 4);
    ...
    public void shouldReturnFirstAndSecondPartAsOne(){
        ...
        List<TimePoint> tps =  TimePointMaker.doTimePoint(Arrays.asList(r1, r2, r3), newYear.plusHours(20), 5, 6);
    ...
    public void shouldReturnSecondAndThirdPartAsOne(){
        ...
        List<TimePoint> tps =  TimePointMaker.doTimePoint(Arrays.asList(r1, r2, r3), newYear.plusHours(20), 3, 5);
    ...
    public void shouldReturnEverythingAsOne(){
        ...
        List<TimePoint> tps =  TimePointMaker.doTimePoint(Arrays.asList(r1, r2, r3), newYear.plusHours(20), 3, 6);
