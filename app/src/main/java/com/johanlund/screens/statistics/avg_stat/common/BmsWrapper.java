...
public class BmsWrapper implements TagsWrapperBase {
    ...
    /**
     * Except for chunkend this is basically a copy of TagsWrapper makeTagsWrappers, only the
     * latter is tested.
     ...
     * @return
     */
    public static List<TagsWrapperBase> makeBmsWrappers(List<Tag> allTags, List<ScoreTime>
            scoreTimes,
