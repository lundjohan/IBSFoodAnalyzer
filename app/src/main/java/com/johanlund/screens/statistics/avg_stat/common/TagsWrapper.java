...
public class TagsWrapper implements TagsWrapperBase {
    ...
    //TODO this method could use same methods as Break.getRatingTimes, we only have to write
    // smaller methods
    public static List<TagsWrapperBase> makeTagsWrappers(List<Tag> allTags, List<ScoreTime>
            scoreTimes,
        ...
        for (int i = 0; i < breaks.size(); i++) {
            ...
            //meaningless to make new RAtingTimes with only chunkEnd (this can happen when breaks
