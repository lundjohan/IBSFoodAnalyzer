...
public class ImportOptionViewMvcImpl implements ImportOptionViewMvc {
    ...
    private void initializeViews() {
        ...
        showInfoOnBtnDown(mergeBtn, "This action will ADD to database from external database file.");
        showInfoOnBtnDown(tagTypeImportBtn, "Add Tag Types (milk, running, mediation etc) that don't already exists in database.");
